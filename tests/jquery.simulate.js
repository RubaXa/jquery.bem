...
//		if( this.target !== activeElement ){
//			$(activeElement).simulate('blur');
//			this.simulateEvent(this.target, 'click', this.options);
//		}
//	},
//
...
$.extend( $.simulate.prototype, {
	...
	simulateTab: function (){
		var current = this.target, $next = $(current).nextAll('[tabIndex]:visible:first');

		this.simulateEvent(current, 'keydown', { keyCode: 9, which: 9 });

		$(current).simulate('blur');
